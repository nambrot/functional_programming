...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Ref(x1)) {
      rc10 = true;
      x3 = $as_Lcalculator_Ref(x1);
      var varname = x3.name$2;
      var this$1 = references;
      if ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(this$1, varname)) {
        var temp$expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(varname)).apply__O());
        var temp$references = $as_sci_Map(references.$$minus__O__sc_Map(varname));
        expr = temp$expr;
    ...
    if ($is_Lcalculator_Minus(x1)) {
      var x6 = $as_Lcalculator_Minus(x1);
      var a$2 = x6.a$2;
      var b$2 = x6.b$2;
    ...
    if ($is_Lcalculator_Times(x1)) {
      var x7 = $as_Lcalculator_Times(x1);
      var a$3 = x7.a$2;
      var b$3 = x7.b$2;
    ...
    if ($is_Lcalculator_Divide(x1)) {
      var x8 = $as_Lcalculator_Divide(x1);
      var a$4 = x8.a$2;
      var b$4 = x8.b$2;
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    return new $c_T2().init___O__O(key, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
